      ...
      <div class="modal-card">
        ...
        <div class="modal-header">
          <div class="header-title">
            ...
            <h3>{{ title || (isEditing ? t.editCourseModalTitle : t.addCourseModalTitle) }}</h3>
          </div>
        ...
        <form @submit.prevent="handleSubmit" class="modal-body">
          <div class="form-section">
            <div class="section-header">
              ...
              <h4>{{ t.sectionCourseInfo }}</h4>
            </div>

            <div class="form-group">
              <label for="courseName">{{ t.lblCourseName }}</label>
              <input
                id="courseName"
                v-model="form.name"
                type="text"
                class="form-control"
                placeholder="e.g. Database Management Systems / Veritabanı"
                required
              />
            </div>
...
watch(
  ...
  (newVal) => {
    if (newVal) {
      ...
      form.is_lab_required = newVal.is_lab_required || false
    } else {
      resetForm()
    }
  },
